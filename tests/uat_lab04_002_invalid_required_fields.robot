...
UAT-Lab04-002 Empty First Name
    ...
    Click Register
    Verify Stay On Registration Page With Error    *Please enter your first name!!
...
UAT-Lab04-002 Empty Last Name
    ...
    Input Text    id=phone          091-001-1234
    Click Register
    Verify Stay On Registration Page With Error    *Please enter your last name!!
...
UAT-Lab04-002 Empty First And Last Name
    ...
    Input Text    id=phone          091-001-1234
    Click Register
    Verify Stay On Registration Page With Error    *Please enter your name!!
...
UAT-Lab04-002 Empty Email
    ...
    Input Text    id=phone          091-001-1234
    Click Register
    Verify Stay On Registration Page With Error    *Please enter your email!!
...
UAT-Lab04-002 Empty Phone Number
    ...
    Input Text    id=email          somyod@kkumail.com
    Click Register
    Verify Stay On Registration Page With Error    *Please enter your phone number!!
